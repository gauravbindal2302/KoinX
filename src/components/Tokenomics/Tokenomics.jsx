export default function Tokenomics() {
  return (
    <>
      <div className="tokenomics-section bg-[#f8fafc] rounded-lg lg:p-6 flex flex-col gap-4">
        <h1 className="text-2xl font-semibold">Tokenomics</h1>
        <span className="text-lg font-semibold">Initial Distribution</span>
        <div className="graph flex items-center gap-8">
          <div className="col-1 lg:h-36 lg:w-36 bg-[#67e8f9] rounded-full"></div>
